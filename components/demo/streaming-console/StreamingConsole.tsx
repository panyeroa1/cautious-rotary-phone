...
export default function StreamingConsole() {
  ...
  useEffect(() => {
    ...
    let constructedSystemPrompt = systemPrompt;
    // Inject previous conversation history if available
    if (turns.length > 0) {
      const history = turns
      ...
      if (history.trim()) {
        constructedSystemPrompt += `\n\n--- PREVIOUS CONVERSATION CONTEXT ---\nThe following is a transcript of the conversation so far. The connection may have been interrupted. Use this context to continue seamlessly.\n\n${history}\n\n--- END OF CONTEXT ---`;
      }
    }
    ...
    setConfig(config);
  }, [setConfig, systemPrompt, tools, voice, turns]);
